...
//
///**
// * This class handle the {'http://www.allcolor.org/xmlns/yahp','pb'} tag and cut
// * document in multiples documents according to it.
// *
// * @author Quentin Anciaux
// * @version 0.94
// */
...
//                                            Node c = ndoc.adoptNode(Sibling.cloneNode(true));
//                                            Node pb = ((Element) c)
//                                                    .getElementsByTagNameNS("http://www.allcolor.org/xmlns/yahp", "pb")
//                                                    .item(0);
//                                            Node p = pb;
//                                            Node pp = pb.getParentNode().getPreviousSibling();
//
